...
public class AuditAspect {
    ...
    public long getAccountId(Object[] methodArgs) {
        Account account;
    ...
    public void logDeposit(JoinPoint joinPoint) {
        ...
        applicationContext.publishEvent(new DepositEvent(getAccountId(methodArgs),
                (double) methodArgs[1]));
    }
    ...
    public Object logWithdrawal(ProceedingJoinPoint thisJoinPoint) throws Throwable {
        ...
        applicationContext.publishEvent(
                new WithdrawEvent(accountId,
                        (double) methodArgs[1], WithdrawEvent.State.TRYING));
